...
const Carousel = () => {
	...
	return (
		<div className='h-[580px] w-full m-auto py-16 relative group z-10'>
			<div
				style={{ backgroundImage: `url(${slides[currentIndex].url})` }}
				className='w-full h-full bg-center bg-cover duration-500 relative bg-[url(${slides[currentIndex].url})]'
			>
