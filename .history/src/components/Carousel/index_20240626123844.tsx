...
const Carousel = () => {
	...
	return (
		<div className='relative z-10'>
			<div className='h-[580px] w-full m-auto py-16 relative group'>
				<div
				...
				<div className='hidden group-hover:block absolute top-[50%] translate-y-[-50%] right-5 text-2xl rounded-full p-2 bg-black/20 text-white cursor-pointer z-20'>
